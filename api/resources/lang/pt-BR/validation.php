...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'street'    =>  'rua',
        'canceled_reason' => 'motivo cancelamento',
        'cellphone' => 'celular',
        'product_category_id' => 'id da categoria do produto',
        'store_category_id' => 'id da categoria da loja',
        'store_id' => 'id da loja',
        'store' => 'loja',
        ...
        'cd_rede' => 'código da rede',
        'nm_rede' => 'nome da rede',
        'cd_origem' => 'código da origem',
        'nm_origem' => 'nome da origem',
        'nu_cartao' => 'número do cartão',
        'tp_status_conta' => 'status da conta',
        'card_password' => 'senha do cartão',
        'secret_question' => 'pergunta secreta',
        'value' => 'valor',
        'price' => 'preço',
        'document' => 'documento',
        'code_external' => 'código externo',
        'externalNsu' => 'nº externo',
        'code_auth' => 'código de autorização',
        'code' => 'código',
        'recovery_code' => 'código de recuperação',
        'email' => 'e-mail',
        'company' => 'empresa',
        'salary_id' => 'código do salário',
        'work_hour_id' => 'código da carga horária',
